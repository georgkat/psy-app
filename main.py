...
def register(data:UserCreate):
    ...
    try:
        ...
        if f == []:
            ...
            content=f'''Здравствуйте, {data.user_name}!\n
Добро пожаловать на SpeakYourMind.Help! Мы рады, что вы выбрали нас для поиска своего психолога.\n
Ваш пароль: {password}
Теперь вы можете:\n
...
Удачного начала вашего пути к улучшению жизни!\nС уважением,Команда Speak your mind
'''
